...
export const Header = () => {
  ...
  return (
    <div className="sm:w-full  sm:px-8 bg-white sm:sticky sm:z-10  sm:top-0">
      <div className="sm:max-w-screen-xl sm:m-auto sm:pb-[50px] sm:flex sm:justify-center sm:items-center sm:gap-[118px] sm:py-8">
